object LearningScala1 {
  ...
  val hello: String = "Hellllo...."               //> hello  : String = Hellllo....
  println(hello)                                  //> Hellllo....
  
  // Notice how Scala defines things backwards from other languages - you declare the
  // name, then the type.
  
  // VARIABLES are mutable
  var helloThere: String = hello                  //> helloThere  : String = Hellllo....
  helloThere = hello + " There!"
  println(helloThere)                             //> Hellllo.... There!
  ...
  val immutableHelloThere = hello + "There!"      //> immutableHelloThere  : String = Hellllo....There!
  println(immutableHelloThere)                    //> Hellllo....There!
